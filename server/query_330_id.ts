...
pool.query(`SELECT table_data->>'product_id' as pid, table_data->>'material_id' as mid, table_data->>'product_name' as name FROM boq_items WHERE table_data::text LIKE '%330.41%'`)
